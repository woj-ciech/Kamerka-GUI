...
(function() {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function() {
        ...
        return h(c, a), c.prototype.init = function() {
            ...
            lineWidth: 3,
            pointSize: 4,
            lineColors:["#ff00cd", "#00E1FF", "#0064d7", "#0a141d", "##15171A"],
            pointStrokeWidths: [1],
            pointStrokeColors: ["#00E1FF"],
            pointFillColors: [],
            smooth: !0,
            xLabels: "auto",
            xLabelFormat: null,
        ...
        return h(d, c), d.prototype.init = function() {
            ...
            barSizeRatio: .75,
            barGap: 3,
            barColors: ["#ff00cd", "#00E1FF", "#0064d7", "#0a141d", "##15171A"],
            barOpacity: 1,
            barRadius: [0, 0, 0, 0],
            xLabelMargin: 50
        ...
        return h(d, c), d.prototype.defaults = {
            colors: ["#ff00cd", "#00E1FF", "#0064d7", "#0a141d", "##15171A"],
